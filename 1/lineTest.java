...
public class lineTest {
	...
	static public void main(String[] args){
		...
		T.setColor (1.0f, 1.0f, 1.0f);
		 ...
		 R.drawLine( 100, 100, 100, 150, T );  /* Vertical OK */
		 R.drawLine( 100, 100, 100, 50, T );   /* Vertical OK */
		
		 R.drawLine( 100, 100, 50, 100, T );  /*   Horizontal OK */
		 R.drawLine( 100, 100, 150, 100, T);  /* Horizontal OK */
		
		 R.drawLine( 100, 100, 150, 150, T );  /* + diagonal OK */
		 R.drawLine( 100, 100, 50, 50, T );    /* + diagonal OK */
		
		R.drawLine( 100, 100, 50, 150, T );   /* - diagonal */
		R.drawLine( 100, 100, 150, 50, T );   /* - diagonal */
		
		R.drawLine( 100, 100, 150, 125, T );    /* shallow + slope OK  */
		 R.drawLine( 100, 100, 50, 75, T );    /* shallow + slope OK  */
